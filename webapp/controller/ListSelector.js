sap.ui.define([
	...
	return BaseObject.extend("project.MDApp.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias project.MDGateway.model.ListSelector
		 */
		 ...
		 * @return {project.MDGateway.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
