sap.ui.define([
	...
	return BaseController.extend("project.MDApp.controller.CreateDetailEntity", {

		_oBinding: {},

		onInit: function () {
			var that = this;
			this.getRouter().getTargets().getTarget("createDetail").attachDisplay(null, this._onDisplay, this);
		...
		_onCreate: function (oEvent) {
			if (oEvent.getParameter("name") && oEvent.getParameter("name") !== "createDetail") {
			...
			this._oViewModel.setProperty("/mode", "createDetail");
			var oContext = this._oODataModel.createEntry("OrderSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("OrderSet", oData);
