sap.ui.define([
	...
	return BaseController.extend("project.MDApp.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("CustomerSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("CustomerSet", oData);
